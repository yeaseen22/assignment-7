      ...
      <div className="relative mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
        <header className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-semibold text-white">{th('Dev News')}</h1>
              <p className="mt-1 text-sm text-zinc-400">{th('Signals from the builders shaping tomorrow.')}</p>
            </div>
          </div>
        ...
        <main className="mt-12">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h2 className="text-xl font-semibold text-white">{t('trending_today')}</h2>
              <p className="mt-1 text-sm text-zinc-400">{t('trending_subtitle')}</p>
            </div>
          </div>
